...
-- ----------------------------
-- Table structure for bee_file_tag
-- ----------------------------
DROP TABLE IF EXISTS `bee_file_tag`;
CREATE TABLE `bee_file_tag` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '标签表自增id',
  `tag_id` varchar(50) NOT NULL COMMENT '标签id',
  `file_id` varchar(50) NOT NULL COMMENT '关联文件id',
  `user_id` varchar(50) NOT NULL COMMENT '关联用户id',
  `tag_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '标签名称',
