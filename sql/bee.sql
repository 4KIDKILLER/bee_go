...
CREATE TABLE `bee_file`  (
  ...
  `file_original_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '原文件名',
  ...
  `file_thumb_path` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '预览图片地址',
  ...
  `status` tinyint NULL DEFAULT 1 COMMENT '文件状态:1正常 2禁用 3已删除',
