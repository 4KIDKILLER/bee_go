...
func (userDao *UserDao) SelectUserByNameAndPassword(username, password string) (beeUser *model.BeeUser, err error) {
...
func (userDao *UserDao) SelectUserByUId(userId int) (beeUser *model.BeeUser, err error) {
	beeUser = &model.BeeUser{}
